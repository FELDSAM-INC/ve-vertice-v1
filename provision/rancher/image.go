...
func (p *rancherProvisioner) getBuildImage(re *repository.Repo, version string) string {
...
func (p *rancherProvisioner) usePlatformImage(re *repository.Repo) bool {
	return true
}

func (p *rancherProvisioner) cleanImage(appName, imgName string) {
	//	shouldReme := true
